...
These exchanges update which stocks they support and ALPACA may add other exchanges in future. Therefore, our watchlist msut be periodically updated.
These helper functions aim to improve the watchlsit creation process.

I took the .csvs from https://www.nasdaq.com/market-activity/stocks/screener and the helper fucntions read these .csvs a
snd create a text file to store our watchlist. 
...
def create_watchlist_text_file(tickers: list, out_path: str):
    ...
    *out: output path string
    ...
    with open(out_path, "w") as f:
        _ = [f.write(convert_ticker_to_alpaca_format(symbol) + "\n") for symbol in tickers]
